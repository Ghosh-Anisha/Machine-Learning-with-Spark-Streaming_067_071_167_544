...
model = MLPClassifier(activation='tanh', learning_rate='constant',alpha=1e-4, hidden_layer_sizes=(15,), random_state=1, batch_size=1,verbose= False, max_iter=1, warm_start=True)
...
def preprocessing(df):
	...
	try:
		...
		#model = SGDClassifier(alpha=.0001, loss='log', penalty='l2', n_jobs=-1, shuffle=True)
		model = MLPClassifier(activation='tanh',learning_rate='constant',alpha=1e-4, hidden_layer_sizes=(70,), random_state=1, batch_size=500,verbose= False, max_iter=1, warm_start=True,shuffle=True)
